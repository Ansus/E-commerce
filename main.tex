\documentclass[12pt,a4paper,oneside,italian]{book}\usepackage[]{graphicx}\usepackage[]{color}
...
\usepackage{booktabs}      %da qui: kableExtra
...
\usepackage[normalem]{ulem} %fino a qui:kableExtra
